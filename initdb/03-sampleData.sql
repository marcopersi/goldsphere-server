...
INSERT INTO product (name, productTypeId, metalId, issuingCountryId, producerId, weight, weightUnit, purity, price, currency, year, description, imageUrl, imageFilename, inStock, stockQuantity, minimumOrderQuantity, premiumPercentage, createdat)
VALUES
    -- Gold Coins
    ('American Gold Eagle', 

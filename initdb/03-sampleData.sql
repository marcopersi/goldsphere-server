...
VALUES
    ...
    ('American Gold Eagle', 
     ...
     (SELECT id FROM producer WHERE producerName = 'United States Mint'),
        31.1035, 'troy_ounces', 0.9167, 2150.50, 'USD', 2024, 'Official gold bullion coin of the United States', 'https://example.com/gold-eagle.jpg', 'gold-eagle.jpg', true, 50, 1, 3.5, CURRENT_TIMESTAMP),
    ('Canadian Gold Maple Leaf', 
     ...
     (SELECT id FROM producer WHERE producerName = 'Royal Canadian Mint'),
        31.1035, 'troy_ounces', 0.9999, 2165.75, 'USD', 2024, 'Canadian Gold Maple Leaf coin with 99.99% purity', 'https://example.com/maple-leaf.jpg', 'maple-leaf.jpg', true, 100, 1, 3.0, CURRENT_TIMESTAMP),
...
-- Insert additional sample users (admin and test users already created in initial load)
INSERT INTO users (email, username, passwordhash, createdat, updatedat)
VALUES
    ('john.doe@example.com', 'John Doe', '$2b$10$JnY0rEXKbSy7CIhRKMQt0u7NjAK9WahB6vkmQnOKzIIui5Js4GYrS', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('jane.smith@example.com', 'Jane Smith', '$2b$10$JnY0rEXKbSy7CIhRKMQt0u7NjAK9WahB6vkmQnOKzIIui5Js4GYrS', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
